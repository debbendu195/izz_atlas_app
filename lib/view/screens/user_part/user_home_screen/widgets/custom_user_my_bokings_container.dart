...
class CustomUserMyBokingsContainer extends StatelessWidget {
  const CustomUserMyBokingsContainer({super.key});
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                            ...
                            child: CustomText(text: "Waiting for vendor’s approval...", fontSize: 12,fontWeight: FontWeight.w400,color: AppColors.white,)
                        ),
                        CustomImage(imageSrc: AppIcons.eyeImage,height: 40,width: 40,)
                      ],
                    ),
                    SizedBox(height: 20,)
                  ],
