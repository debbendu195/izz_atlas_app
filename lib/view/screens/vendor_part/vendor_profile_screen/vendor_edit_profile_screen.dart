...
class VendorEditProfileScreen extends StatelessWidget {
  ...
  final vendorProfileController = Get.find<VendorProfileController>();
  @override
          ...
          children: [
            Center(
              child: Stack(
                children: [
                  Obx(() {
                    if (vendorProfileController.selectedImage.value != null) {
                      return Container(
                        height: 100.h,
                        width: 100.w,
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: FileImage(vendorProfileController.selectedImage.value!),
                            fit: BoxFit.cover,
                          ),
                        ),
                      );
                  ...
                  Positioned(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        vendorProfileController.pickImageFromGallery();
                      },
                      child: Container(
                        height: 30,
                        width: 30,
